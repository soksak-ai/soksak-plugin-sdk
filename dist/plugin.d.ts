import type { OverlayScope, PluginManifest, PluginRuntimeCommandOutcome, PluginRuntimeJson, PluginRuntimeRole } from "@soksak/soksak-spec";
export type { PluginManifest, PluginRuntimeJson, PluginRuntimeRole, } from "@soksak/soksak-spec";
...
export interface PluginEventRegistryClient {
    subscribe(topic: string, listener: (value: PluginRuntimeJson) => void): Promise<SandboxDisposable>;
}
...
export type PluginDeepReadonly<T> = T extends (...args: never[]) => unknown ? T : T extends readonly (infer Item)[] ? readonly PluginDeepReadonly<Item>[] : T extends object ? {
...
export type PluginCommandHandler = (params: PluginJsonObject, context: PluginCommandContext) => PluginCommandOutcome | Promise<PluginCommandOutcome>;
interface ActiveVisualContext<Role extends "view" | "file-viewer" | "overlay"> extends PluginFrameContextBase<SandboxedPluginApp, Role> {
    readonly root: HTMLElement;
    readonly context: Readonly<PluginFrameState & {
        readonly slot: PluginFrameSlot;
    }>;
}
interface PreviewVisualContext<Target extends "view" | "file-viewer" | "overlay"> extends PluginFrameContextBase<PreviewPluginApp, "preview"> {
    readonly root: HTMLElement;
...
export type PluginViewInstanceContext = ActiveVisualContext<"view"> | PreviewVisualContext<"view">;
...
export type PluginFileViewerContext = ActiveVisualContext<"file-viewer"> | PreviewVisualContext<"file-viewer">;
...
export type PluginOverlayContext = (ActiveVisualContext<"overlay"> | PreviewVisualContext<"overlay">) & {
...
export declare function pluginModuleInventory(module: SoksakPluginModule): {
 ...
 */
export declare function derivePluginCommandInventory(contributions: Pick<PluginManifest["contributes"], "commands">): {
    readonly runtime: readonly string[];
    readonly service: readonly string[];
};
export declare function selectSoksakPluginProvider(module: SoksakPluginModule, selector: {
