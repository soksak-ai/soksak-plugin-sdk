...
import { assertCleanSourceCheckout, assertRegularDirectory, finalizePackageOutput, runPackagingCommand, } from "./component-packaging.js";
...
export function packagePluginRelease(input) {
    ...
    if (input.store !== undefined)
        assertRegularDirectory(input.store, "local release store");
    ...
    try {
        ...
        if (evidence.length === 0)
            throw new Error("Plugin release has no conformance evidence");
        runPackagingCommand(process.execPath, [
